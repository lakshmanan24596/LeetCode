...
/*
    1) Brute force:
        time: n*k
        space: n
        logic: Queue (linkedlist) or Circular linked list
        code: https://leetcode.com/problems/find-the-winner-of-the-circular-game/discuss/1152460/JAVA-Queue-self-explanatory
